...
A TUI for git worktrees. Create one from a short slug, install its npm deps, and `cd`
straight into it.
...
- **npm**: new worktrees can run `npm ci`, at any depth, so they build on arrival.
